...
export default defineMessages({
    essentialLabel: {
        id: 'app.cookiesModal.advancedCookiesSettingsForm.essentialLabel',
        description: 'Essential Cookies field label.',
        defaultMessage: 'Essential Cookies',
    },
    essentialDescription: {
        id: 'app.cookiesModal.advancedCookiesSettingsForm.essentialDescription',
    ...
    performanceLabel: {
        id: 'app.cookiesModal.advancedCookiesSettingsForm.performanceLabel',
        description: 'Performance Cookies field label.',
        defaultMessage: 'Performance Cookies',
    },
    performanceDescription: {
        id: 'app.cookiesModal.advancedCookiesSettingsForm.performanceDescription',
    ...
    functionalLabel: {
        id: 'app.cookiesModal.advancedCookiesSettingsForm.functionalLabel',
        description: 'Functional Cookies field label.',
        defaultMessage: 'Functional Cookies',
    },
    functionalDescription: {
        id: 'app.cookiesModal.advancedCookiesSettingsForm.functionalDescription',
    ...
    advertisingLabel: {
        id: 'app.cookiesModal.advancedCookiesSettingsForm.advertisingLabel',
        description: 'Advertising Cookies field label.',
        defaultMessage: 'Advertising Cookies',
    },
    advertisingDescription: {
        id: 'app.cookiesModal.advancedCookiesSettingsForm.advertisingDescription',
    ...
    socialLabel: {
        id: 'app.cookiesModal.advancedCookiesSettingsForm.socialLabel',
        description: 'Social Media Cookies field label.',
        defaultMessage: 'Social Media Cookies',
    },
    socialDescription: {
        id: 'app.cookiesModal.advancedCookiesSettingsForm.socialDescription',
